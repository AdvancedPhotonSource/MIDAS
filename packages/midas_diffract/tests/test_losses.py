"""Comprehensive unit tests for the loss-function library.
...
from midas_diffract.losses import ImageComparisonLoss, SpotMatchingLoss, SpotAssigner
...
from midas_diffract.losses import (
